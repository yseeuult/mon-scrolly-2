...
// le texte des boites
  ...
  let stepsData = [
    ...
    { "text": "Le taux de recyclage belge de <mark style='background-color:#32CBFF80; color:white; padding 2px; border-radius: 5px;'> 80,4% des emballages depuis 2021 </mark>, soit un peu moins de 1,6 millions de tonnes." },
    { "text": "Depuis 2001, le taux de recyclage belge a augmenté de 9%, allant de 71,8% (un peu moins de 1,2 millions de tonnes) à 80,4% en 2021." },
		...
		{"text": "Que ce soit aujourd'hui que il y a 20 ans, le plastique persiste en tant que déchet le moins recyclé. Cependant, son taux de recyclage a significativement grimpé, passant de 28% en 2001 à 49% en 2021."}
  ];
